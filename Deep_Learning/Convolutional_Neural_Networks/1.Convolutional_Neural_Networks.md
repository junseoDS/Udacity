...
When we design an algorithm to classify objects in images, we have to deal with a lot of __irrelevant information__.

We want our algorithm to learn an invariant representation of the image : 

* Scale Invariance
* Rotation Invariance
* Translation Invariance

If you want your CNN to be  invariance, you can expand the training set by augmenting the data

Data Augmentaion also help us to avoid overfitting.
...
ImageNet is a database of over 10 million hand labeled images, drawn from 1000 different image categories. 
